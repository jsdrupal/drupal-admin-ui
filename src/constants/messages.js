...
// messageInterface – components through which messages can be rendered.
export const MESSAGE_INTERFACE_SNACKBAR = 'MESSAGE_INTERFACE_SNACKBAR';
export const MESSAGE_INTERFACE_BANNER = 'MESSAGE_INTERFACE_BANNER';
