...
storiesOf('Widgets/BooleanCheckbox', module).addWithJSX('Default', function () {
  return React.createElement(BooleanCheckbox, {
...
storiesOf('Widgets/DatetimeTimestamp', module).addWithJSX('Default', function () {
  return React.createElement(DatetimeTimestamp, {
...
storiesOf('Widgets/EntityReferenceAutocomplete', module).addWithJSX('Default', function () {
  return React.createElement(EntityReferenceAutocomplete, {
    bundle: 'recipe',
    entityTypeId: 'node',
...
storiesOf('Widgets/FileUploadWidget/Single File', module).addWithJSX('Default', function () {
  return React.createElement(FileUploadWidget, {
    bundle: 'node',
...
storiesOf('Widgets/FileUploadWidget/Multiple File', module).addWithJSX('Default', function () {
  return React.createElement(FileUploadWidget, {
    bundle: 'node',
    entityTypeId: 'Article',
    fieldName: 'image-file',
...
storiesOf('Widgets/NumberTextfield', module).addWithJSX('Default', function () {
...
storiesOf('Widgets/OptionsSelect', module).addWithJSX('Default', function () {
  return React.createElement(OptionsSelect, {
...
storiesOf('Widgets/StringTextfield', module).addWithJSX('Default', function () {
  return React.createElement(StringTextfield, {
    fieldName: 'userBio',
...
storiesOf('Widgets/TextTextarea', module).addWithJSX('Default', function () {
  return React.createElement(TextTextarea, {
