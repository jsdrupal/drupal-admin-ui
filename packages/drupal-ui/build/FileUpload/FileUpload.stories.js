 ...
 */
var onFileUploadAction = action('onFileUpload');
onFileUploadAction.toString = function () {
  return "action('onFileUpload')";
};

storiesOf('FileUpload', module).addWithJSX('Default', function () {
